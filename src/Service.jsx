	...
	return (
						<div className="col-md-4 col-lg-4 mb-3 text-center">
							<div className="box_border col-lg-9 p-3 pt-4 m-auto rounded">
								<img src={props.scardimage} className="img-fluid mb-2" width="20%" />
		...
		<>
			...
			<div className="container mx-auto py-5">
					<div className="mb-5 text-center">
						<p className="display-6 mb-1">Our Services</p>
			...
			<section className="bg-light">
				<div className="container py-5 text-center">
					...
					<p className="text-muted">Why not visit our <NavLink class="text-decoration-none" to="/contact">contact page</NavLink>, we would love to chat with you!</p>
				</div>
			</section>
