...
const Tcards = (props) => {
	return (
			...
			<figure class="figure col-md-3 text-center">
			  <img src={props.timage} class="figure-img img-fluid rounded col-lg-6 col-7 col-md-10" alt="team3" />
			  <figcaption class="figure-caption text-dark">{props.ttitle}</figcaption>
			</figure>
		);
};
			...
			<section>
				<div className="container py-5 m-auto">
					<div className="mb-4">
						...
						<p class="d-lg-block d-none col-8 m-auto text-center">These people are the reason for our success and stainless reputation.<br/>They have years of experience and absolute dedication to what they do.</p>
					</div>
